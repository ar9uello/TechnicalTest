...
{
    public class CreateMovieBuyValidator : AbstractValidator<MovieBuy>
    {
        private readonly IMovieInventoryRepository _repository;

        public CreateMovieBuyValidator(IMovieInventoryRepository repository)
        {
        ...
        private async Task<bool> IsStatusInventory(MovieBuy e, CancellationToken token)
        {
